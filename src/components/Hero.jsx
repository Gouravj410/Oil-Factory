  ...
  const oilProducts = useMemo(() => [
    {
      ...
      image: `${import.meta.env.BASE_URL}images/bottle-models/Mustard.png`,
      video: `${import.meta.env.BASE_URL}images/mustardvideo.mp4`,
      videoScale: 1.15,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/bottle-models/Soyabean.png`,
      video: `${import.meta.env.BASE_URL}images/soyabeanvideo.mp4`,
      videoScale: 1.15,
      videoBrightness: 0.85,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/bottle-models/Cottonseed.png`,
      video: `${import.meta.env.BASE_URL}images/cottonseedvideo.mp4`,
      videoScale: 1,
        ...
        {oilProducts.map((product, i) => (
          <motion.video
            ...
            style={{
              ...
              filter: `brightness(${product.videoBrightness ?? 1}) contrast(1.45) saturate(1.3)`
            }}
            initial={{ opacity: 0 }}
