  ...
  const showcaseItems = [
    {
      ...
      productImages: ["./images/bottle-models/Mustard.png", "./images/bottle-models/Mustard Can.png", "./images/bottle-models/Mustard Tin.png"],
      dishNames: ["Spicy Aloo Dum", "Rich Paneer Tikka", "Traditional Fish Curry"],
      dishImages: ["./authentic_aloo_dum.png", "./paneer_tikka.png", "./mustard_fish_curry.png"],
    ...
    },
    {
      ...
      productImages: ["./images/bottle-models/Soyabean.png", "./images/bottle-models/Soyabean Can.png", "./images/bottle-models/Soyabean Tin.png"],
      dishNames: ["Comforting Dal Tadka", "Fragrant Veg Pulao", "Classic Aloo Curry"],
      dishImages: ["./healthy_dal.png", "./veg_pulao.png", "./authentic_aloo_dum.png"],
    ...
    },
    {
      ...
      productImages: ["./images/bottle-models/Cottonseed.png", "./images/bottle-models/Cottonseed Tin.png"],
      dishNames: ["Crispy Samosas & Pakodas", "Tandoori Snacks"],
      dishImages: ["./crispy_samosa.png", "./paneer_tikka.png"],
