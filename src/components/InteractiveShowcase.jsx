  ...
  const showcaseItems = [
    {
      ...
      dishNames: ["Spicy Aloo Dum", "Rich Paneer Tikka", "Spicy Aloo Dum"],
      dishImages: ["./authentic_aloo_dum.png", "./paneer_tikka.png", "./authentic_aloo_dum.png"],
    ...
    },
    {
      ...
      dishNames: ["Comforting Dal Tadka", "Fragrant Veg Pulao", "Comforting Dal Tadka"],
      dishImages: ["./healthy_dal.png", "./veg_pulao.png", "./healthy_dal.png"],
    ...
    },
    {
      ...
      dishNames: ["Crispy Samosas & Pakodas", "Crispy Snacks"],
      dishImages: ["./crispy_samosa.png", "./crispy_samosa.png"],
